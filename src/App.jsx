...
const SHOP={
  costumes:[
    {id:"street",n:"ストリートウェア",p:500,b:{style:2},col:"#4a4a7a",desc:"定番ストリートスタイル"},
    {id:"hip",n:"ヒップホップパンツ",p:700,b:{rhythm:2,stamina:1},col:"#2a4a2a",desc:"バギーパンツ"},
    {id:"leo",n:"ダンスレオタード",p:600,b:{technique:2,style:1},col:"#4a0a6a",desc:"クラシック用タイトウェア"},
    {id:"battle",n:"バトルジャケット",p:900,b:{stamina:2,charisma:1},col:"#3a0a0a",desc:"バトル向けジャケット"},
    {id:"stage",n:"ステージスーツ",p:1500,b:{charisma:3,style:2},col:"#0a0a4a",desc:"ステージ映え豪華スーツ"},
    {id:"gold",n:"ゴールドコスチューム",p:5000,b:{charisma:5,style:3},col:"#3a2200",desc:"レジェンド専用黄金衣装"},
  ],
  sneakers:[
    {id:"af1",n:"Air Force 1",p:800,b:{rhythm:2},col:"#f8f8f8",sol:"#dddddd",desc:"ハウスの定番白AF1"},
    {id:"aj1",n:"Air Jordan 1",p:1500,b:{stamina:3,rhythm:2},col:"#dd2222",sol:"#111111",desc:"パワーとスタイル両立"},
    {id:"blazer",n:"Nike Blazer",p:700,b:{style:2},col:"#e8c880",sol:"#c8a860",desc:"ビンテージな佇まい"},
    {id:"cortez",n:"Nike Cortez",p:600,b:{rhythm:1,stamina:1},col:"#f8f0e0",sol:"#4444cc",desc:"クラシックランナー"},
    {id:"timb",n:"Timberland",p:900,b:{stamina:3},col:"#c8860a",sol:"#8a5a00",desc:"ストリートの王道ブーツ"},
    {id:"chuck",n:"Chuck Taylor",p:550,b:{charisma:1,style:1},col:"#cc2222",sol:"#ffffff",desc:"永遠のオールスター"},
    {id:"vans",n:"Vans Old Skool",p:680,b:{style:2,rhythm:1},col:"#222222",sol:"#eeeeee",desc:"スケーターの魂"},
    {id:"reebok",n:"Reebok Classic",p:650,b:{technique:1,rhythm:1},col:"#ffffff",sol:"#cccccc",desc:"クリーンなクラシック"},
  ],
  accessories:[
    {id:"chain",n:"ゴールドチェーン",slot:"neck",p:400,b:{charisma:2},desc:"ゴールドが輝く存在感"},
    {id:"sunglass",n:"サングラス",slot:"face",p:350,b:{charisma:1,style:1},desc:"クールな一枚"},
    {id:"bandana",n:"バンダナ",slot:"forehead",p:200,b:{style:1},desc:"額に巻いてスタイルアップ"},
    {id:"cap",n:"スナップバックキャップ",slot:"head",p:450,b:{charisma:1,rhythm:1},desc:"かぶって気合い入れろ"},
    {id:"beanie",n:"ビーニー",slot:"head",p:300,b:{style:1,stamina:1},desc:"どんな時も全力で"},
    {id:"fan",n:"ゴールドファン",slot:"hand",p:1500,b:{charisma:3,style:2},desc:"ワッキングの女王専用"},
  ],
};

/* ── MAP DATA ── */
const J={
  kagoshima:{id:"kagoshima",name:"鹿児島",x:152,y:408,g:"house",lv:1,cn:["kumamoto","miyazaki"],ch:{name:"溶岩ハウサー・ケン",e:"🌋",pw:45},rw:{exp:160,coins:400,title:"鹿児島の王"},desc:"火山の島から生まれたHOUSEの聖地"},
  miyazaki:{id:"miyazaki",name:"宮崎",x:200,y:365,g:"breaking",lv:3,cn:["kagoshima","kumamoto","oita"],ch:{name:"サーファーBreaker・Ryo",e:"🏄",pw:78},rw:{exp:220,coins:600,title:"宮崎ライダー"},desc:"南国の太陽の下のBREAKINGスタイル"},
  nagasaki:{id:"nagasaki",name:"長崎",x:86,y:316,g:"waacking",lv:5,cn:["kumamoto","hakata"],ch:{name:"海の女神・マリア",e:"⛵",pw:112},rw:{exp:300,coins:800,title:"長崎ソウルクイーン"},desc:"港町の哀愁を纏うSOUL & WAACKING"},
  kumamoto:{id:"kumamoto",name:"熊本",x:148,y:330,g:"lock",lv:5,cn:["kagoshima","miyazaki","oita","nagasaki","hakata"],ch:{name:"熊本城ロッカー・Tomo",e:"🏯",pw:110},rw:{exp:290,coins:750,title:"熊本ロックダウン"},desc:"お城の麓で炸裂するLOCK"},
  oita:{id:"oita",name:"大分",x:200,y:298,g:"jazz",lv:7,cn:["miyazaki","kumamoto","kokura"],ch:{name:"温泉ジャズマン・Hiro",e:"♨",pw:140},rw:{exp:360,coins:900,title:"大分スウィング"},desc:"湯けむりの中に流れるJAZZ"},
  hakata:{id:"hakata",name:"博多",x:136,y:296,g:"lock",lv:8,cn:["nagasaki","kumamoto","kokura"],ch:{name:"屋台ロックキング・Shin",e:"🍜",pw:158},rw:{exp:400,coins:1100,title:"博多の王者"},desc:"熱い男たちのLOCKが博多の夜を揺らす"},
  kokura:{id:"kokura",name:"小倉",x:166,y:284,g:"house",lv:9,cn:["hakata","oita","hiroshima"],ch:{name:"鉄の街ハウサー・Masa",e:"🏭",pw:180},rw:{exp:450,coins:1300,title:"小倉HouseChamp"},desc:"鉄の街のHOUSEスタイル"},
  hiroshima:{id:"hiroshima",name:"広島",x:148,y:252,g:"contemporary",lv:11,cn:["kokura","kobe"],ch:{name:"平和の踊り子・Nana",e:"🕊",pw:212},rw:{exp:520,coins:1600,title:"広島コンテポラリー"},desc:"平和への祈りを込めたCONTEMPORARY"},
  kobe:{id:"kobe",name:"神戸",x:184,y:226,g:"waacking",lv:12,cn:["hiroshima","osaka"],ch:{name:"港の女王・Yuki",e:"⚓",pw:240},rw:{exp:580,coins:1800,title:"神戸ディスコクイーン"},desc:"異国情緒の港町のWAACKING"},
  osaka:{id:"osaka",name:"大阪",x:208,y:224,g:"popping",lv:13,cn:["kobe","kyoto"],ch:{name:"難波POPPINキング・Taka",e:"🐡",pw:255},rw:{exp:600,coins:2000,title:"大阪の帝王"},desc:"ど派手なPOPPINGが大阪を沸かせる！"},
  kyoto:{id:"kyoto",name:"京都",x:194,y:210,g:"ballet",lv:14,cn:["osaka","nagoya"],ch:{name:"舞妓バレリーナ・Kei",e:"🏮",pw:272},rw:{exp:650,coins:2200,title:"京都の雅"},desc:"千年の都の和と洋の融合バレエ"},
  nagoya:{id:"nagoya",name:"名古屋",x:228,y:202,g:"breaking",lv:16,cn:["kyoto","tokyo","yokohama"],ch:{name:"モーニングBreaker・Jun",e:"☕",pw:304},rw:{exp:720,coins:2600,title:"名古屋城の破壊者"},desc:"味噌の街のBREAKINGパワー"},
  yokohama:{id:"yokohama",name:"横浜",x:280,y:190,g:"breaking",lv:18,cn:["nagoya","tokyo"],ch:{name:"港ブレイカー・Daisuke",e:"🛳",pw:342},rw:{exp:800,coins:3000,title:"横浜レジェンド"},desc:"関東最強の横浜ブレイキン"},
  tokyo:{id:"tokyo",name:"東京",x:294,y:172,g:"popping",lv:22,cn:["yokohama","sendai"],ch:{name:"東京ゴッド・ZERO",e:"🏙",pw:425},rw:{exp:1000,coins:5000,title:"東京の覇者"},desc:"全スタイルが集結する日本の聖地"},
  sendai:{id:"sendai",name:"仙台",x:290,y:122,g:"lock",lv:26,cn:["tokyo","sapporo"],ch:{name:"七夕LOCKer・Tanaka",e:"🎋",pw:482},rw:{exp:1100,coins:6000,title:"東北のLOCK王"},desc:"七夕のリズムに乗るLOCK"},
  sapporo:{id:"sapporo",name:"札幌",x:272,y:50,g:"jazz",lv:30,cn:["sendai"],ch:{name:"雪のジャズダンサー・Miku",e:"❄",pw:565},rw:{exp:1300,coins:8000,title:"北の王者"},desc:"雪と氷の中に咲くJAZZ"},
};
...
const QOPPS=[
  {id:"q1",name:"ルーキーのレン",style:"Popping",e:"🤖",lv:2,pw:30,rw:{exp:50,coins:120}},
  {id:"q2",name:"ハウスのハナ",style:"House",e:"💃",lv:5,pw:70,rw:{exp:90,coins:220,title:"バトルデビュー！"}},
  {id:"q3",name:"ロックキングLeo",style:"Lock",e:"🦁",lv:10,pw:140,rw:{exp:180,coins:440,title:"ローカルチャンピオン"}},
  {id:"q4",name:"バレエの女王Bea",style:"Ballet",e:"👸",lv:18,pw:260,rw:{exp:350,coins:840,title:"テクニシャン"}},
  {id:"q5",name:"ストリート王者Shin",style:"Breaking",e:"⚡",lv:30,pw:450,rw:{exp:700,coins:2000,title:"ストリートの王者"}},
  {id:"q6",name:"ワールドスターYuki",style:"Contemporary",e:"🌟",lv:45,pw:800,rw:{exp:1300,coins:5000,title:"ワールドクラス"}},
];
  ...
  return(
    <div>
      ...
      {items.map(item=>{
        ...
        return(
          <div key={item.id} style={{background:eq?`${genre.c}18`:BG2,border:`1px solid ${eq?genre.c+"66":BD}`,borderRadius:8,padding:"12px 14px",marginBottom:10}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:6}}>
              <div style={{flex:1}}>
                {sub==="sneakers"&&<div style={{display:"flex",gap:5,marginBottom:5}}><div style={{width:26,height:12,borderRadius:3,background:item.col,border:"1px solid #444"}}/><div style={{width:26,height:6,borderRadius:2,background:item.sol,border:"1px solid #444",marginTop:3}}/></div>}
                ...
                <div style={{fontWeight:700,fontSize:13,color:eq?genre.c:TX,fontFamily:"M PLUS Rounded 1c,sans-serif",marginTop:sub==="accessories"?4:0}}>{eq&&"✦ "}{item.n}</div>
                <div style={{fontSize:10,color:TX3,marginTop:2}}>{item.desc}</div>
              </div>
              <div style={{marginLeft:8}}><div style={{fontSize:12,color:owned?"#60c080":canBuy?"#b3ff00":"#ff6060",fontWeight:700}}>{owned?"所持済み":fc(item.p)}</div></div>
            </div>
            <div style={{display:"flex",flexWrap:"wrap",gap:5,marginBottom:8}}>{Object.entries(item.b).map(([k,v])=><Tag key={k} col={SM[k]?.c||"#888"}>{SM[k]?.jp}+{v}</Tag>)}</div>
            <div style={{display:"flex",gap:8}}>
...
/* ── STATUS TAB ── */
function StatusTab({char,lv,rnk,genre}){
  const eb=bonus(char.equipped||{});
...
function Game({char,setChar,onTitle}){
  ...
  useEffect(()=>{
    const t=setInterval(()=>{setChar(c=>({...c,energy:Math.max(0,c.energy-1),hunger:Math.max(0,c.hunger-2),mood:c.energy<15||c.hunger<15?Math.max(0,c.mood-2):Math.min(100,c.mood+1)}));},12000);
  ...
  function doRest(){setChar(c=>({...c,energy:Math.min(100,c.energy+40),mood:Math.min(100,c.mood+15)}));notif2("ぐっすり休んだ！💤","#00e5ff");addLog("休息した。");}
  function doEat(){setChar(c=>({...c,hunger:Math.min(100,c.hunger+55),energy:Math.min(100,c.energy+12)}));notif2("おいしかった！🍱","#ff9ec4");addLog("食事した。");}
  ...
  return(
    <div style={{minHeight:"100vh",background:BG,fontFamily:"M PLUS Rounded 1c,sans-serif",paddingBottom:80}}>
      ...
      {/* header */}
      <div style={{padding:"10px 16px",background:BG2,borderBottom:`2px solid ${genre.c}55`,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      ...
      <div style={{padding:"14px 16px 0"}}>
        ...
        {tab==="status"&&<StatusTab char={char} lv={lv} rnk={rnk} genre={genre}/>}
      </div>
      {/* nav */}
...
export default function DancerLegend(){
  ...
  function start(name,genre,hometown){
    ...
    const newChar={name,genre,hometown,currentCity:hometown,clearedCities:{[hometown]:true},
      exp:0,coins:500,fame:0,energy:85,mood:80,hunger:70,stats,
